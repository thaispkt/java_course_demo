...
public class Account {
    ...
    // Phương thức chuyển khoản từ tài khoản này sang tài khoản khác Chú ý: Mỗi thao tác phải kiểm tra số tiền nạp, rút,
    // chuyển có hợp lệ hay không? (VD: tiền nhập vào)
    public void transfer(Account destinationAccount, float transferAmount) {
    ...
    // ToString method to return a string containing all account information in currency format
    @Override
