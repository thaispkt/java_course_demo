//Hãy viết chương trình Chào Hỏi các thành viên của gia đình có đặc điểm sau đây: đầu tiên máy sẽ hỏi ai đang sử dụng máy. Sau đó căn cứ vào câu trả lời nhận được mà máy cần  đưa ra một câu chào hợp lý, dễ thương. Giả sử trong gia đình có 4 thành viên là : Bố (B), Mẹ (H), anh trai (A) và em gái (E)
