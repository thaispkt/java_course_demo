...
public class RoleController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (path.equals("/role")) {
            System.out.println("Call: doGetRoleTable(req,resp)");
    ...
    private void doGetRoleTable(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("List<RoleEntity> roleList = roleService.getAllRoles()");
        List<RoleEntity> roleList = roleService.getAllRoles();
        for(RoleEntity role: roleList) {
            System.out.println("Kiem tra: " + role.getName());
        }
