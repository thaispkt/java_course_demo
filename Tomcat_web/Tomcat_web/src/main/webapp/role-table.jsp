                         ...
                         <div class="white-box">
                             <div class="table-responsive">
                                 <table class="table" id="example">
                                     ...
                                     <tbody>
                                     <c:forEach var="line" items="${listRole}" >
                                        <tr>
                                            <td>${line.id}</td>
                                            <td>${line.name}</td>
                                            <td>${line.desc}</td>
                                            <td>
                                                ...
                                                <!-- <a href="/role-delete?id=${line.id}" class="btn btn-sm btn-danger">Xóa</a> -->
                                                <!-- <a href="#" id="btn-delete" class="btn btn-sm btn-danger">Xóa</a> Dùng ID sẽ bị trùng -->
                                                <a href="#" role-id="${line.id}" class="btn btn-sm btn-danger btn-xoa">Xóa</a>
                                            </td>
                                        </tr>
                                     </c:forEach>
